...
from utils.image_processing import decode_png_bytes_to_image, display_image_from_base64_matplotlib
from utils.image_processing import _get_images, _get_prediction
    ...
    if "images" in image_data and image_data["images"]:
        ...
        if st.button("Run Segmentation"):
            with st.spinner("Processing image..."):
                ...
                result = _get_prediction(selected_image)
